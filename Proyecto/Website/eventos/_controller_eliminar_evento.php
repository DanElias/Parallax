...
echo '
            ...
            <div class="modal-content my_modal_content">
                ...
                <div class="my_modal_buttons">
                    <div class="row">
                        ...
                        <div class="col s12 m6">
                            <a class="btn red" type="submit" name="action" href="_eliminar_evento.php?id='.$_GET['id'].'">Estoy
    ...
    "<script type='text/javascript'>
            ...
            jQuery(document).ready(function(){
                  jQuery('#_form_eliminar_evento').modal();
                  jQuery(document).ready(function(){
                      jQuery('#_form_eliminar_evento').modal('open');
                  });
            });
    </script>";
