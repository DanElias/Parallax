...
//cierra la conexión con la base de datos
 ...
 //obtiene todas las tuplas con todos sus datos
    ...
    function registrar_tutor($nombre,$fecha,$telefono,$ocupacion,$empresa,$titulo,$grado){
      $conn = conectDb();
      $sql = "INSERT INTO tutor(nombre,telefono,fecha_nacimiento,ocupacion,nombre_empresa,grado_estudio,titulo_obtenido) VALUES(\"".$nombre."\",\"".$fecha."\",\"".$telefono."\",\"".$ocupacion."\",\"".$empresa."\",\"".$titulo."\",\"".$grado."\")";
      if(mysqli_query($conn,$sql)){
          closeDb($conn);
          return true;
      }else{
