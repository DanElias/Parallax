<?php
  ...
  <div class="row">
      <div class="input-field col s4">
          ...
          <input  type="text" class="validate ubuntu-text" id="enombre_tutor" name="nombre_tutor" value="'.$row['nombre'].'" required>
          <label for="nombre_tutor">Nombre(s)</label>
      </div>
      <div class="input-field col s4">
          <!--i class="material-icons prefix">person</i-->
          <input  type="text" class="validate ubuntu-text" id="eapellido_tutor" name="apellido_tutor" value="'.$row['apellido'].'" required>
  ...
  <div class="row">
      <div class="input-field col s4">
          ...
          <input  type="text" class="validate ubuntu-text" id="etelefono" value="'.$row['telefono'].'" name="telefono" required>
          <label for="telefono">Telefono</label>
      </div>
      <div class="input-field col s4">
          <i class="material-icons prefix">work</i>
          <input  type="text" class="validate ubuntu-text" id="eocupacion" value="'.$row['ocupacion'].'" name="ocupacion" required>
          <label for="ocupacion">Ocupacion </label>
      </div>
      <div class="input-field col s4">
          <i class="material-icons prefix">domain</i>
          <input  type="text" class="validate ubuntu-text" id="eempresa" value="'.$row['nombre_empresa'].'" name="empresa" required>
  ...
  <div class="row">
      ...
      <div class="input-field col s4">
          ...
          <input  type="text" class="validate ubuntu-text" id="etitulo" name="titulo" value="'.$row['titulo_obtenido'].'" required>
