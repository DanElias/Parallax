<?php
    ...
    echo "Proveedor: ".$rfc;
    echo "Cuenta: ".$id_cuentacontable;
   

    /*
    echo "<h1>HOLA, YA LLEGO AL PHP PARA SER REGISTRADO</h1>";
    if(registrar_egreso('B','CONCEPTO',9.1,'20-12-2019','OBSERVACIONES','00000','AAAAAAAAAABB9',1)){
        echo "Se registro";
    }*/
    /*
    if(registrar_egreso($folio,$concepto,$importe,$fecha,$cuenta_bancaria,$rfc,$id_cuentacontable,$observaciones)){
        echo "SE REGISTRO EL EGRESO";
         //header("location:./_egresos_vista.php");
    }*/
   /*
