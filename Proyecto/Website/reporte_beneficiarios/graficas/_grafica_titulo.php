...
$valores="";
$result=reporteTitulo();

while($row = mysqli_fetch_array($result)){ 
    $str=mb_convert_encoding($row["titulo_obtenido"], "EUC-JP", "auto");
...
<div id="_grafica_titulo" class="modal my_modal modal1  my_big_modal" name="modal1">
    <div class="row my_modal_header_row">

        <div class="my_modal_header1">
            <div class="col s11 my_form_title">
                Reporte de Tutores - Títulos Obtenidos
            </div>

            <div class="col s1">
                <br>
                <a class="my_modal_buttons btn btn-medium waves-effect waves-light modal-close red accent-3 hoverable center"
                   style="font-size:2em;font-family: Roboto;" href="#_grafica_titulo">
                    ×
                </a>
            </div>
        </div>
        ...
        <script type="text/javascript">  
            ...
            {  
                ...
                var data = google.visualization.arrayToDataTable([  
                          [\'Titulo Obtenido\', \'Numero\'],'.$valores.'
                     ]);  
                var options = {
                    \'legend\':\'right\',
                    \'pieSliceText\':\'left\',
                    \'title\':\'Títulos obtenidos por los Tutores\',
                    \'titleTextStyle\': {
                    \'fontSize\': \'16\' },
                    \'width\':800,
                    \'height\':700,
                ...
                var chart = new google.visualization.PieChart(document.getElementById(\'_grafica_titulo_div\'));  
            ...
            <div class="row">
                ...
                <div class="col s8">
                    <div id="_grafica_titulo_div" style="margin: 0 auto;"></div> 
                </div>
