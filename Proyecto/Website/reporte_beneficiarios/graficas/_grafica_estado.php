...
<div id="_grafica_estado" class="modal my_modal modal1  my_big_modal" name="modal1">
    <div class="row my_modal_header_row">

        <div class="my_modal_header1">
            <div class="col s11 my_form_title">
                Reporte de Beneficiarios - Activos e Inactivos
            </div>

            <div class="col s1">
                <br>
                <a class="my_modal_buttons btn btn-medium waves-effect waves-light modal-close red accent-3 hoverable center"
                   style="font-size:2em;font-family: Roboto;" href="#_grafica_estado">
                    ×
                </a>
            </div>
        </div>
        ...
        <script type="text/javascript">  
            ...
            {  
                ...
                var data = google.visualization.arrayToDataTable([  
                          [\'Estado\', \'Numero\'],'.$valores.'
                     ]);  
                var options = {
                    \'legend\':\'left\',
                    \'pieSliceText\':\'left\',
                    \'title\':\'Beneficiarios Activos e Inactivos\',
                    \'titleTextStyle\': {
                    \'fontSize\': \'16\' },
                    \'width\':800,
                    \'height\':700,
                ...
                var chart = new google.visualization.PieChart(document.getElementById(\'_grafica_estado_div\'));  
            ...
            <div class="row">
                ...
                <div class="col s8">
                    <div id="_grafica_estado_div" style="margin: 0 auto;"></div> 
                </div>
