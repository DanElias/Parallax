...
$valores="";
$result=reporteGrupo(1);

while($row = mysqli_fetch_array($result)){ 
    $str=mb_convert_encoding($row["grupo"], "EUC-JP", "auto");
        ...
        <script type="text/javascript">  
            ...
            {  
                ...
                var data = google.visualization.arrayToDataTable([  
                          [\'Grupo\', \'Numero\'],'.$valores.'
                     ]);  
                var options = {
                    \'legend\':\'left\',
                    \'pieSliceText\':\'left\',
                    \'title\':\'Número de Beneficiarios presentes en los Grupos\',
                    \'titleTextStyle\': {
                    \'fontSize\': \'16\' },
                    \'width\':\'700\',
                    \'height\':\'600\',
                ...
                var chart = new google.visualization.PieChart(document.getElementById(\'_grafica_grupo_div\'));  
            ...
            <div class="row">
                ...
                <div class="col s8">
                    <div id="_grafica_grupo_div" style="margin: 0 auto;"></div> 
                </div>
