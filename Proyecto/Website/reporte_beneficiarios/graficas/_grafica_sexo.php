    ...
    <div class="modal-content my_modal_content">
        ...
        <script type="text/javascript">  
            ...
            {  
                ...
                var chart = new google.visualization.PieChart(document.getElementById(\'_grafica_sexo_div\'));  
            ...
            <div class="row">
                ...
                <div class="col s8">
                    <div id="_grafica_sexo_div" style="margin: 0 auto;"></div> 
                </div>
